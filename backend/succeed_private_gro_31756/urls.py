"""succeed_private_gro_31756 URL Configuration
...
admin.site.site_header = "Succeed Private Group"
admin.site.site_title = "Succeed Private Group Admin Portal"
admin.site.index_title = "Succeed Private Group Admin"

# swagger
api_info = openapi.Info(
    title="Succeed Private Group API",
    default_version="v1",
    description="API documentation for Succeed Private Group App",
)
