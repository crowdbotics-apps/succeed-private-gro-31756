...
## Project Structure
    ...
    ├── succeed_private_gro_31756  # Django project configurations
...
1. Clone this repo and `cd succeed_private_gro_31756`
...
2. Clone this repo and `cd succeed_private_gro_31756`
